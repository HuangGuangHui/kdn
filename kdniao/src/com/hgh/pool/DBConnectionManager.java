...
import com.hgh.pool.ParseDSConfig;
import com.hgh.pool.DSConfigBean;
import com.hgh.pool.DBConnectionPool;
/**
 * @author chenyanlin
 *
 */
public class DBConnectionManager {
 ...
 //读取数据库配置文件
  drivers=pd.readConfigInfo("dsconfig.xml");
 }
 /**
  * @param args
  */
